...
<div class="row">
<div class="col-md-12">
<h3>Insert New Certificate Details</h3><h5 style="float:right;"><?php echo $_SESSION['email']; ?></h5>
<br>
...
$select =" select * from tblusers where email = '$useremail' ";
...
?>  
    ...
    <td><a href="home.php?del=<?php echo htmlentities($result['id']);?>"><button class="btn btn-danger btn-xs" onClick="return confirm('Do you really want to delete');"><span class="glyphicon glyphicon-trash"></span></button></a></td>
    </tr>
